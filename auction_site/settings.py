...
SECRET_KEY = '#&%bl4p+6j^@btu)gl$2wm5lv7ivy*j_2vj*hg%*a=cink*k0s'
...
INSTALLED_APPS = [
    ...
    'auctions',   
    'drf_yasg',  # Biblioteca do Swagger      # O aplicativo de leilão precisa estar listado aqui
]
# Configuração do Channels para WebSockets com Redis
